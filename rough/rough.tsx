...
// {
//     const { selectedProducts, setSelectedProducts }: { selectedProducts: any, setSelectedProducts: any } = useContext(ProductsContext);
//     const [productsInfos, setProductsInfos]: [String, any] = useState([]);
...
//     useEffect(() =>
//     {
//         const uniqIds: any = [...new Set(selectedProducts)];
//         fetch('/api/products?ids=' + uniqIds.join(','))
//             .then((response: any) => response.json())
//             .then((json: any) => setProductsInfos(json));
//     }, [selectedProducts]);


//     const moreOfThisProduct = (id: any) => { setSelectedProducts(prev => [...prev, id]); }

//     const lessOfThisProduct = (id: any) =>
//     {
//         const pos: any = selectedProducts.indexOf(id);
//         if (pos !== -1) {
...
//     const deliveryPrice: Number = 5;
//     let subtotal: any = 0;
//     if (selectedProducts?.length) {
//         for (let id of selectedProducts) {
//             const price: any = productsInfos.find(p => p._id === id)?.price || 0;
//             subtotal += price;
//         }
//     }
